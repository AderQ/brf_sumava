class brf_sumava {
	...
	disabledTowns[] = {};
	antennas[] = {
		{5352.76,7838.3,0.368622},{9012.25,2230.76,0},{11195.5,7491.4,1.20309},{768.341,3056.67,0.000862122},{310.292,2006.35,0.234848},{713.314,11490.4,0.22364}
	};
	banks[] = {}; // no banks on map
	garrison[] = {}; // not sure how to set this up
	fuelStationTypes[] = {
